...
| --------------------------------------------- | --------------------------- | ---------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- | --- |
| [Latin](../../terms/latin-script.md)          | English, French, Vietnamese | Alphabetic baseline                                                                      | Symbols sit on the baseline, and descenders drop below it.<sup>1</sup> | page |
...
| [Tamil](../../terms/tamil-script.md)          | Tamil                       | Alphabetic baseline                                                                      | An [abugida](../../terms/abugida.md) like Devanagari, but its symbols sit on the baseline instead of hanging.<sup>3</sup> | தமிழ் (tamizh) |
