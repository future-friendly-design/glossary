...
The line spacing in vertical text is not measured from baseline to baseline. In Japanese for example, each symbol ([character](../../programming-terms/text-in-software/character.md)) sits in an invisible bounding box, and the line spacing is measured between the bounding boxes from one vertical line of text to the next.<sup>10</sup>
