...
In typography, the baseline refers to an invisible line that aligns glyphs that are placed together to form words. For example, in the [Latin script](../../language-terms/writing-systems-and-scripts/latin-script.md), the bottoms of the letters "o," "n," and "m" rest on top of the alphabetic baseline, while the tail of "g" (known as the [descender](descender.md)) drops below it.
...
| [Devanagari](../../language-terms/writing-systems-and-scripts/devanagari.md)       | Hindi, Marathi, Nepali      | [Hanging baseline](../../language-terms/writing-systems-and-scripts/hanging-baseline.md) | Symbols hang from a top line, the [shirorekha](../../language-terms/writing-systems-and-scripts/shirorekha.md).<sup>2</sup>                                    | नमस्ते (namaste) |
| [Tamil](../../language-terms/writing-systems-and-scripts/tamil-script.md)          | Tamil                       | Alphabetic baseline                                                                      | An [abugida](../../language-terms/writing-systems-and-scripts/abugida.md) like Devanagari, but its symbols sit on the baseline instead of hanging.<sup>3</sup> | தமிழ் (tamizh)   |
| [CJK](../../language-terms/writing-systems-and-scripts/cjk.md) (Han, Hangul, Kana) | Chinese, Japanese, Korean   | Ideographic baseline                                                                     | Glyphs fill a square and align to its top and bottom edges, not a letter baseline.<sup>4</sup>                                                                 | 你好 (nǐ hǎo)      |
...
In scripts that run horizontally, whether [left-to-right](../../language-terms/writing-systems-and-scripts/left-to-right.md) or [right-to-left](../../language-terms/writing-systems-and-scripts/right-to-left.md), symbols rest on the baseline, and it is the reference a font's vertical metrics are measured from. Which metrics those are depends on the script. Latin is bicameral, so it has a [cap-height](cap-height.md) and an [x-height](x-height.md) alongside the reach of [ascender](ascender.md)s and descenders. [Arabic](../../language-terms/writing-systems-and-scripts/arabic-script.md) and [Hebrew](../../language-terms/writing-systems-and-scripts/hebrew-script.md) run horizontally and rest on a baseline too, but both are unicameral, a single case, so they have no cap height or x-height;<sup>5</sup> they carry their own heights, and Arabic's ascenders and descenders reach much further above and below the baseline than Latin's.<sup>6</sup> A shared direction and a shared baseline do not mean shared metrics. [Leading](leading.md), the vertical spacing controlled by [line-height](line-height.md), is measured from the baseline of one line of text to the baseline of the line below it.<sup>7</sup>

Beyond the space the letters themselves take up, every font also reserves empty space above its tallest glyphs and below its lowest, built into the font's own metrics, so a line of text rarely sits flush against the edges of its bounding box. Both design tools and code offer a way to trim that reserved space back to the cap height and baseline (see known as [vertical-trim](vertical-trim.md) in design and `text-box-trim` in CSS).<sup>8</sup>
...
The line spacing in vertical text is not measured from baseline to baseline. In Japanese for example, each symbol ([character](../../programming-terms/text-for-digital-products-and-the-web/character.md)) sits in an invisible bounding box, and the line spacing is measured between the bounding boxes from one vertical line of text to the next.<sup>10</sup>
...
[Abugida](../../language-terms/writing-systems-and-scripts/abugida.md) · [Arabic script](../../language-terms/writing-systems-and-scripts/arabic-script.md) · [Ascender](ascender.md) · [Cap height](cap-height.md) · [Character](../../programming-terms/text-for-digital-products-and-the-web/character.md) · [CJK](../../language-terms/writing-systems-and-scripts/cjk.md) · [Descender](descender.md) · [Devanagari script](../../language-terms/writing-systems-and-scripts/devanagari.md) · [Glyph](../../programming-terms/text-for-digital-products-and-the-web/glyph.md) · [Han characters script](../../language-terms/writing-systems-and-scripts/han-characters.md) · [Hanging baseline](../../language-terms/writing-systems-and-scripts/hanging-baseline.md) · [Hangul script](../../language-terms/writing-systems-and-scripts/hangul.md) · [Hebrew script](../../language-terms/writing-systems-and-scripts/hebrew-script.md) · [Latin script](../../language-terms/writing-systems-and-scripts/latin-script.md) · [Leading](leading.md) · [Left-to-right](../../language-terms/writing-systems-and-scripts/left-to-right.md) · [Line height](line-height.md) · [Right-to-left](../../language-terms/writing-systems-and-scripts/right-to-left.md) · [Script rules](../../language-terms/writing-systems-and-scripts/script-rules.md) · [Shirorekha](../../language-terms/writing-systems-and-scripts/shirorekha.md) · [Symbol](../../language-terms/writing-systems-and-scripts/symbol.md) · [Tamil script](../../language-terms/writing-systems-and-scripts/tamil-script.md) · [Tategaki](../../language-terms/writing-systems-and-scripts/tategaki.md) · [Text direction](../../language-terms/writing-systems-and-scripts/text-direction.md) · [Typography](../../terms/typography.md) · [Vertical trim](vertical-trim.md) · [x-height](x-height.md)
