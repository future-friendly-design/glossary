...
depth: deep
summary: >-
  A typeface is the overall design of a set of letters, numbers, and symbols
  that share a common visual style.
related:
  - font
  - font-weight
  - variable-font
...
This is the design itself, the artwork, separate from any one file that delivers it. A typeface is the whole family (Helvetica, a widely used sans-serif), and a [font](../../programming-terms/text-for-digital-products-and-the-web/font.md) is one specific instance inside it (Helvetica Bold at 12pt). In everyday speech people swap the two words freely, and that is fine in conversation. It starts to bite the moment you are specifying type for a real product, because "use Helvetica" does not tell anyone which weight or style, and a design system needs that precision.
...
Treating a typeface as a single thing you can just "apply," when what you actually ship is a set of fonts: regular, bold, italic, and so on. If you pick a typeface that only ships a regular weight and then ask for bold anyway, the tool or browser may fake it (see [faux-bold](../../programming-terms/text-for-digital-products-and-the-web/faux-bold.md)), which distorts the letterforms. Choosing a typeface means checking that the family actually includes the weights and styles your design depends on.
...
[Faux bold](../../programming-terms/text-for-digital-products-and-the-web/faux-bold.md) · [Font](../../programming-terms/text-for-digital-products-and-the-web/font.md) · [Font weight](font-weight.md) · [Variable font](variable-font.md)
