...
Where [legibility](legibility.md) is about recognizing a single character, readability is about the whole passage: how easily the eye takes in the words and travels along each line and down to the next. It is a typographic property set by spacing and layout: the [line length](../../design-terms/typography/measure.md), the [leading](../../design-terms/typography/leading.md) between lines, the letter and word spacing ([tracking](../../design-terms/typography/tracking.md)), the alignment, and the size. Legibility is the zoomed-in view of type, readability the zoomed-out one.
...
* **Set measure with a token, not by eye:** cap line length in the comfortable range so paragraphs do not stretch across wide screens, where the eye loses the start of the next line. See [measure](../../design-terms/typography/measure.md).
* **Tune leading to the text, not a default:** body copy, dense tables, and large headings each want different [line height](../../design-terms/typography/line-height.md); set them as steps in the type scale so the rhythm stays consistent across components.
...
[Leading](../../design-terms/typography/leading.md) · [Legibility](legibility.md) · [Line height](../../design-terms/typography/line-height.md) · [Measure](../../design-terms/typography/measure.md) · [Tracking](../../design-terms/typography/tracking.md)
