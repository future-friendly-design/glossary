...
Script rules define the behaviour of individual visual elements of a script (its symbols, including marks). For example, the Latin script has a text direction rule of left-to-right.
