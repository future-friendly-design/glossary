...
| Languages                         | Arabic, Persian, Urdu, Pashto, Sindhi, Kashmiri, Uyghur, and many others                                                       |
...
* **Cover the script before you commit a typeface:** confirm the font ships the Arabic glyphs AND the [shaping rules](../../programming-terms/text-for-digital-products-and-the-web/text-shaping.md) that position them, not just the base letters. See [font coverage](../../terms/font-coverage.md).
