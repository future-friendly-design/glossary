...
* **Cover the script before you commit a typeface:** Armenian is a common gap in fonts built mainly for Latin or the other large scripts, so a font that looks complete may ship no Armenian glyphs at all. Confirm coverage explicitly, both cases. See [font coverage](../../terms/font-coverage.md).
