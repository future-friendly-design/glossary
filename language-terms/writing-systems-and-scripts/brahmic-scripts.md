...
| Rendering                           | [Complex text layout](../../programming-terms/text-for-digital-products-and-the-web/complex-text-layout.md): real shaping, mark positioning, and sometimes reordering, not simple glyph placement | You need real [text shaping](../../programming-terms/text-for-digital-products-and-the-web/text-shaping.md) and [OpenType](../../design-terms/typography/opentype.md) rules; simple glyph placement renders the text wrong, not just unstyled  |
...
| [Thai](thai-script.md)                  | Thai                             | อักษรไทย         | No spaces between words, needing [word segmentation](../../programming-terms/text-in-software/segmentation.md); some vowel marks sit to the left |
...
* **Cover the specific member, not "Brahmic" in general:** confirm the [font](../../programming-terms/text-for-digital-products-and-the-web/font.md) ships the glyphs AND the shaping rules for the exact script you need, not just a related one. The [Noto](../../design-terms/typography/noto-fonts.md) project covers the family with free, open-licensed families per script, and reaches scripts where commercial fonts are scarce. See [font coverage](../../programming-terms/text-for-digital-products-and-the-web/font-coverage.md).
* **Reuse the infrastructure, but re-test each member:** if you already support one Brahmic script, you likely have the [complex text layout](../../programming-terms/text-for-digital-products-and-the-web/complex-text-layout.md) pieces in place, but test the new member with a real word, because conjuncts, reordering, and mark placement differ from script to script.
