...
| [Unicode](../../programming-terms/text-for-digital-products-and-the-web/unicode.md) block                   | Unified Canadian Aboriginal Syllabics, [U+1400 to U+167F](https://www.unicode.org/charts/PDF/U1400.pdf) (plus Extended and Extended-A)                                                                                                                                                                            | The primary user community spans several Indigenous groups across Canada,<sup>6</sup> and the symbols spread across a base block and extensions, so confirm [font coverage](../../programming-terms/text-for-digital-products-and-the-web/font-coverage.md) for the specific language, not just the common Cree set |
