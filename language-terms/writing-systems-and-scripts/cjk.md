...
| [Han characters](han-characters.md) | All three traditions use Han characters (hanzi, kanji, hanja), encoded once as CJK Unified Ideographs                                                                                                                                                  | Set the text's language so the shared [code points](../../programming-terms/text-in-software/code-point.md) render with the right regional glyphs                                                                                                                       |
| Square layout                       | Characters are written within uniformly sized squares ([full-width](../../programming-terms/text-in-software/full-width.md)), so text sets on a fixed grid<sup>5</sup>                                                                                 | Design to a fixed character grid rather than proportional spacing                                                                                                                                                                                                       |
