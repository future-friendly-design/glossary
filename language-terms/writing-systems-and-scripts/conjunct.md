...
To a font, that merge is drawn by rendering the first consonant in a reduced half-form and attaching the next, sometimes stacking them vertically. A [shaping engine](../../terms/shaping-engine.md) selects which conjuncts form through [OpenType](../../terms/opentype.md) rules, and which clusters join depends on the language and the font.<sup>2</sup>
