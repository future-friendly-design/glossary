...
* **Cover the script before you commit a typeface:** confirm the font ships both cases AND the localized forms for the specific languages you support, since Russian, Serbian, and Bulgarian differ in both their letterforms and, for some languages, the specific letters they use. See [font coverage](../../terms/font-coverage.md).
