...
| [OpenType](../../design-terms/typography/opentype.md)                                                       | The font uses standard [OpenType features](../../design-terms/typography/opentype-features.md): glyph substitution and [kerning](../../design-terms/typography/kerning.md); because each consonant-and-vowel syllable is a single [precomposed character](../../programming-terms/text-for-digital-products-and-the-web/precomposed-character.md), there are no mandatory shaping features | The work is coverage, not shaping: confirm the font carries the full syllable set (see the Unicode block row), but no special shaping is required. See the Text shaping row below                                                                                                                                                                |
...
| [Unicode](../../programming-terms/text-for-digital-products-and-the-web/unicode.md) block                   | Ethiopic, [U+1200 to U+137F](https://www.unicode.org/charts/PDF/U1200.pdf) (plus Ethiopic Supplement and the Ethiopic Extended blocks)                                                                                                                                                                                                                                                     | Ensure [font coverage](../../programming-terms/text-for-digital-products-and-the-web/font-coverage.md) of the block and its extensions; the large syllable set means a partial subset drops real syllables                                                                                                                                       |
