...
| Mtavruli                                                  | An all-caps style of Mkhedruli used for titles and emphasis, which behaves like all-caps rather than a sentence-initial capital<sup>6</sup> | Reach for Mtavruli deliberately when you want an all-caps effect; don't fake capitals by scaling letters or forcing Latin-style title casing                                                                           |
...
7. Georgian text runs left to right in horizontal lines - Georgian (r12a script notes) [https://r12a.github.io/scripts/geor/ka.html](https://r12a.github.io/scripts/geor/ka.html)
