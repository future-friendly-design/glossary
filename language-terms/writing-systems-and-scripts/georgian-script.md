...
| [Font](../../terms/font.md) (open source)                 | [Noto Sans Georgian](https://fonts.google.com/noto/specimen/Noto+Sans+Georgian) is a free, open-source font covering the script's characters and any shaping it needs | Start here rather than licensing or commissioning a commercial typeface; confirm it covers the languages you support (see [font coverage](../../terms/font-coverage.md)). [Noto](../../terms/noto-fonts.md) reaches scripts where commercial fonts are scarce |
