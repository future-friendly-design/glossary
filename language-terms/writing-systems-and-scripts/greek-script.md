...
* **Cover the script before you commit a typeface:** confirm the font ships both cases AND the accented vowels (with the tonos), not just the bare letters. See [font coverage](../../terms/font-coverage.md).
