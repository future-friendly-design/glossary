...
depth: core
summary: >-
  The hanging baseline is the top alignment line that letters hang from in
  scripts like Devanagari and Tibetan, rather than the bottom line that Latin
  letters sit on.
related:
  - baseline
  - shirorekha
...
[Baseline](../../design-terms/typography/baseline.md) · [Bengali-Assamese](../../terms/bengali-assamese.md) · [Devanagari](../../terms/devanagari.md) · [Latin script](../../terms/latin-script.md) · [Line height](../../terms/line-height.md) · [Shaping & layout](../../terms/shaping-layout.md) · [Shirorekha](shirorekha.md) · [Tibetan script](../../terms/tibetan-script.md) · [Typography](../../terms/typography.md)
