...
| ------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Autonym](../linguistics/autonym.md) | אלף־בית עברי                                                                                                                                                                                  |
...
| Dagesh                                                                                                      | A dot placed inside a letter; it is not a vowel, it is a [mark](mark.md) that changes how the consonant is pronounced (in ב, כ, and פ it switches the sound; in most other letters it marks a doubled consonant)<sup>4</sup>                                                            | Optional and often omitted, like niqqud: the same word may render with or without it, so treat both forms as the same word in search and matching                                                                                                                                                                                                                                                                                                                            |
...
| [Font](../../programming-terms/text-for-digital-products-and-the-web/font.md) (open source)                 | [Noto Sans Hebrew](https://fonts.google.com/noto/specimen/Noto+Sans+Hebrew) is a free, open-source font from Google's [Noto](../../design-terms/typography/noto-fonts.md) project, covering the script's characters and the OpenType features they need (see OpenType and Text shaping) | Treat the typeface as a foundational choice, and confirm it covers every language you support that uses the script (see [font coverage](../../programming-terms/text-for-digital-products-and-the-web/font-coverage.md)), not just one                                                                                                                                                                                                                                       |
| [Joining](joining.md)                                                                                       | Not applicable: Hebrew letters are unconnected, each keeping its shape wherever it sits in a word<sup>6</sup>                                                                                                                                                                           | So no positional-form (joining) logic is needed, and [letter spacing](../../design-terms/typography/letter-spacing.md) is less constrained, since the letters never connect                                                                                                                                                                                                                                                                                                  |
...
| [OpenType](../../design-terms/typography/opentype.md)                                                       | The font must include the specific [OpenType features](../../design-terms/typography/opentype-features.md) for mark positioning (niqqud, dagesh) and final-form substitution, beyond plain glyph substitution                                                                           | A font can cover the characters and still leave these features out, so confirm it actually ships them, not just the base glyphs<sup>9</sup>. See the Text shaping row below for the render-time side (right-to-left ordering is separate: see Bidirectional text above)                                                                                                                                                                                                      |
...
| [Text shaping](../../programming-terms/text-for-digital-products-and-the-web/text-shaping.md)               | Shaping happens at render time: the platform's [shaping engine](../../programming-terms/text-for-digital-products-and-the-web/shaping-engine.md) reads the font's OpenType features (see OpenType above) and positions the final forms and any niqqud or dagesh marks                   | A correct font is necessary but not sufficient: a tool or pipeline that places glyphs without shaping renders the marks wrong even with a fully-featured font. Test in the actual design tools your team uses, not just the browser                                                                                                                                                                                                                                          |
| [Unicode](../../programming-terms/text-in-software/unicode.md) block                                        | Hebrew, [U+0590 to U+05FF](https://www.unicode.org/charts/PDF/U0590.pdf)                                                                                                                                                                                                                | No special handling beyond ensuring [font coverage](../../programming-terms/text-for-digital-products-and-the-web/font-coverage.md) of the block, including the final forms and vowel points                                                                                                                                                                                                                                                                                 |
