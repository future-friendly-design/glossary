...
| [Text direction](text-direction.md)                       | [Right to left](right-to-left.md)<sup>11</sup>                                                                                                     | This is the default reading direction for the whole document or component; see Bidirectional text above for what to do about embedded content in the other direction |
