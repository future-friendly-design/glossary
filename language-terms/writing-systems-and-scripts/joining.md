...
| [Mongolian (traditional)](mongolian-script.md) | Mongolian                            | Cursive and joining like Arabic, but written vertically, top to bottom.             |         |
...
Design tooling needs to support shaping; otherwise the tool will display the [characters](../../programming-terms/text-in-software/character.md) but not join them, leaving the script's symbols as separate shapes a reader cannot follow.
