...
2. "They are logographic (each character represents a word, not just a sound) characters that developed from pictographic and ideographic principles." (Chapter 18 reproduces this from the dictionary Kōjien) - The Unicode Standard, Version 17.0, Chapter 18: East Asia [https://www.unicode.org/versions/Unicode17.0.0/core-spec/chapter-18/](https://www.unicode.org/versions/Unicode17.0.0/core-spec/chapter-18/)
3. "Chinese characters represent words (or better, morphemes), not ideas, and they represent them phonetically, for the most part, as do all real writing systems…" - John DeFrancis, The Ideographic Myth [https://www.pinyin.info/readings/texts/ideographic\_myth.html](https://www.pinyin.info/readings/texts/ideographic_myth.html)
