...
depth: core
summary: >-
  A matra is a vowel sign in Indic scripts that attaches to a consonant to show
  its vowel.
related:
  - mark
  - reordering
...
A matra is a kind of [mark](mark.md): a vowel sign that attaches to a consonant rather than standing on its own. In an [abugida](../../terms/abugida.md) such as Devanagari, each consonant already carries a built-in vowel, and a matra changes it to a different one. A matra can sit to the left, right, above, or below the consonant.
...
[Mark](mark.md) · [Reordering](../../terms/reordering.md) · [Conjunct](../../terms/conjunct.md) · [Reph](../../terms/reph.md) · [Complex text layout](../../terms/complex-text-layout.md) · [Abugida](../../terms/abugida.md) · [Unicode](../../terms/unicode.md)
