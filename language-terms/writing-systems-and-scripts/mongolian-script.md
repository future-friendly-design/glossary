...
| --------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| [Autonym](../../terms/autonym.md) | ᠮᠣᠩᠭᠣᠯ ᠪᠢᠴᠢᠭ                                                                                                    |
...
| [Text shaping](../../programming-terms/text-for-digital-products-and-the-web/text-shaping.md) | Shaping happens at render time: the [shaping engine](../../terms/shaping-engine.md) reads the font's OpenType features (see OpenType above) and selects each letter's correct positional and variant form from its context<sup>10</sup>                                                                                                                              | A correct font is necessary but not sufficient: a tool or pipeline that places glyphs without shaping renders Mongolian wrong even with a fully-featured font, and vertical layout compounds it. Test in the actual design tools your team uses, not just the browser                                                                |
| [Unicode](../../terms/unicode.md) block                                                       | Mongolian, [U+1800 to U+18AF](https://www.unicode.org/charts/PDF/U1800.pdf) (plus Mongolian Supplement)                                                                                                                                                                                                                                                              | A Latin or [Cyrillic](cyrillic.md) font will not render it, so confirm [font coverage](../../terms/font-coverage.md) of the block, the positional forms, and the variation selectors                                                                                                                                                 |
...
* **Confirm vertical layout before you commit a typeface or a tool:** verify the font ships the cursive joining and positional forms AND that your layout stack can set vertical, left-to-right columns, not just horizontal lines. See [font coverage](../../terms/font-coverage.md).
* **Test with a real vertical line, not a row of glyphs:** set a real Mongolian word in a vertical column and confirm the letters join, pick up their positional forms, and show the intended shapes (adding free variation selectors where a shape cannot be derived automatically). Tool support for [complex text layout](../../terms/complex-text-layout.md) and vertical text varies, so test early.
