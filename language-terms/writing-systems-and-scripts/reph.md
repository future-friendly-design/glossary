...
On a multi-language website, a Devanagari word is stored in the order its [characters](../../programming-terms/text-in-software/character.md) are typed (क, र, [virama](virama.md), म), but it is not shown in that order: the reph moves up to sit above म. So a design system supporting Devanagari can't treat the stored order of text as the displayed order of text.

Displaying a reph correctly on a website requires both a [font](../../programming-terms/text-for-digital-products-and-the-web/font.md) that includes the reph form of the ra symbol and a [shaping engine](../../programming-terms/text-for-digital-products-and-the-web/shaping-engine.md) that performs the [glyph](../../programming-terms/text-for-digital-products-and-the-web/glyph.md) substitution and reorders the cluster of [symbols](symbol.md) to position the reph.

It's important to remember that supporting another language in a design system isn't limited to translation. Some [writing systems](writing-system.md) have [script rules](script-rules.md), such as reordering (reph is one example), [joining](joining.md), and [stacking](stacking-script.md), that require the system to handle [complex text layout](../../programming-terms/text-for-digital-products-and-the-web/complex-text-layout.md), not just translated strings. Even among languages that share the same script, each adds its own language-specific rules, defined in its [orthography](orthography.md), that can place further requirements on the design system.

***

### Related terms and mentions

[Character](../../programming-terms/text-in-software/character.md) · [Complex text layout](../../programming-terms/text-for-digital-products-and-the-web/complex-text-layout.md) · [Conjunct](conjunct.md) · [Devanagari script](devanagari.md) · [Font](../../programming-terms/text-for-digital-products-and-the-web/font.md) · [Glyph](../../programming-terms/text-for-digital-products-and-the-web/glyph.md) · [Joining](joining.md) · [Matra](matra.md) · [Orthography](orthography.md) · [Reordering](../../programming-terms/text-for-digital-products-and-the-web/reordering.md) · [Script rules](script-rules.md) · [Shaping engine](../../programming-terms/text-for-digital-products-and-the-web/shaping-engine.md) · [Shirorekha](shirorekha.md) · [Stacking script](stacking-script.md) · [Symbol](symbol.md) · [Virama](virama.md) · [Writing system](writing-system.md) · [Writing systems & scripts](./)
...
1. In Devanagari and other scripts of India, the above-base form of RA used at the start of a cluster is a nonspacing combining-mark glyph form of the consonant RA, also known as "repha"; the same cluster-initial RA behaviour occurs in Bengali, Telugu, and Kannada - The Unicode Standard, Version 17.0, Chapter 12 (South Asia-I) [https://www.unicode.org/versions/Unicode17.0.0/core-spec/chapter-12/](https://www.unicode.org/versions/Unicode17.0.0/core-spec/chapter-12/)
