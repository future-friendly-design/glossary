...
| ----------- | -------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| Direction   | which way the script runs: left to right, right to left, or top to bottom                                | [Arabic](../../terms/arabic-script.md) runs right to left; Japanese [tategaki](../../terms/tategaki.md) runs top to bottom | [Text direction](../../terms/text-direction.md), [Left-to-right](../../terms/left-to-right.md), [Right-to-left](../../terms/right-to-left.md)   |
