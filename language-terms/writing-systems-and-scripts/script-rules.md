...
| Breaking    | how the script marks word and line boundaries, which is not always a space                               | [Thai](../../terms/thai-script.md) has no word spaces: ภาษาไทย ("Thai language") is written solid                          | [Segmentation](../../terms/segmentation.md)       |
