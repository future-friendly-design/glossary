...
| Breaking    | how the script marks word and line boundaries, which is not always a space                                                                     | [Thai](thai-script.md) has no word spaces: ภาษาไทย ("Thai language") is written solid                  | [Segmentation](../../programming-terms/text-for-digital-products-and-the-web/segmentation.md), [Tsheg](tsheg.md)                                                                                      |
| Combination | how [marks](../../programming-terms/text-for-digital-products-and-the-web/combining-mark.md) attach to symbols and how symbols cluster or fuse | [Devanagari](devanagari.md) conjuncts                                                                  | [Conjunct](conjunct.md), [Mark](mark.md), [Combining mark](../../programming-terms/text-for-digital-products-and-the-web/combining-mark.md)                                                           |
