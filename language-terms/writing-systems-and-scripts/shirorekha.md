...
* The shirorekha has to join continuously across a whole word, including where consonants form [conjuncts](conjunct.md) or half-forms, or the word looks broken.<sup>1</sup> (It is sometimes called the matra line, which is not the same as a [matra](matra.md) vowel mark.)
