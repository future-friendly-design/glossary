...
When a written language is read, the smallest symbol, or combination of symbols, that distinguishes one meaning from another is a [grapheme](../../programming-terms/text-for-digital-products-and-the-web/grapheme.md). For example, `e` is one symbol and one grapheme; `é` is two symbols, a letter plus an accent mark, but still one grapheme.

When a written language is to be printed or shown on a screen, [typography](../../terms/typography.md) refers to the specific shape a [font](../../programming-terms/text-for-digital-products-and-the-web/font.md) draws for a symbol as a [glyph](../../programming-terms/text-for-digital-products-and-the-web/glyph.md). For example, the `e` and `é` you see on this page are glyphs. The same symbol in the same font can have more than one glyph. For example `e`, _`e`_, **`e`**, _**`e`**_, are the same symbol represented as four different glyphs.

In computer programming, there is a universal coding standard called [Unicode](../../programming-terms/text-for-digital-products-and-the-web/unicode.md). What this glossary calls a symbol, Unicode refers to as a [character](../../programming-terms/text-for-digital-products-and-the-web/character.md). Each character is given a unique ID number called a [code point](../../programming-terms/text-for-digital-products-and-the-web/code-point.md). They reserve the term `symbol` for math symbols like `+`, currency symbols like `$`, modifier symbols, and other symbols such as `©` and emoji `🔠`.<sup>1</sup>
...
* **Keep machine-facing names to a safe character set:** name tokens, files, components, and assets with plain ASCII (letters, digits, hyphens, underscores) and leave emojis, accents, quotes, and slashes for human-readable content, so a name that works in your design tool does not break when it becomes a filename or a code identifier.<sup>6</sup>

***

### Related terms and mentions

[Abjad](abjad.md) · [Alphabet](alphabet.md) · [Character](../../programming-terms/text-for-digital-products-and-the-web/character.md) · [CLDR](../../programming-terms/text-for-digital-products-and-the-web/cldr.md) · [Code point](../../programming-terms/text-for-digital-products-and-the-web/code-point.md) · [Font](../../programming-terms/text-for-digital-products-and-the-web/font.md) · [Glyph](../../programming-terms/text-for-digital-products-and-the-web/glyph.md) · [Grapheme](../../programming-terms/text-for-digital-products-and-the-web/grapheme.md) · [Latin script](latin-script.md) · [Legibility](../../design-terms/typography/legibility.md) · [Locale](../../programming-terms/text-for-digital-products-and-the-web/locale.md) · [Logographic](logographic.md) · [Mark](mark.md) · [Orthography](orthography.md) · [Script](script.md) · [Script rules](script-rules.md) · [Syllabary](syllabary.md) · [Unicode](../../programming-terms/text-for-digital-products-and-the-web/unicode.md) · [Writing system](writing-system.md) · [Writing systems & scripts](./) · [Typography](../../terms/typography.md)
...
6. Windows forbids the characters `< > : " / \ | ? *` in file and directory names and reserves device names such as CON and NUL - Microsoft: Naming Files, Paths, and Namespaces [https://learn.microsoft.com/en-us/windows/win32/fileio/naming-a-file](https://learn.microsoft.com/en-us/windows/win32/fileio/naming-a-file)
