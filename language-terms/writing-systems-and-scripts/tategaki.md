...
depth: core
summary: >-
  Tategaki is the traditional Japanese form of vertical text, set in columns
  that run from top to bottom and are ordered from right to left.
related:
  - vertical-text
  - text-direction
  - full-width
