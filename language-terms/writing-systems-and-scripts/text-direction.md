...
| Top to bottom ([Vertical Text](vertical-text.md)) | Stacked in vertical columns. CJK usually runs horizontally but can be set vertically, its columns advancing right to left ([tategaki](tategaki.md)); traditional Mongolian is written vertically, its columns advancing left to right. | [CJK](../../terms/cjk.md), [Mongolian script (traditional)](../../terms/mongolian-script.md)                                                                           |
