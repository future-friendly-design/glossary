...
For example, the [Latin script](latin-script.md) runs [left to right](left-to-right.md), the [Arabic](../../terms/arabic-script.md) and [Hebrew](../../terms/hebrew-script.md) scripts run [right to left](right-to-left.md), and Japanese can be set top to bottom in vertical columns.
...
| ------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| [Left to right](left-to-right.md) (LTR)                       | Horizontal, starting at the left edge; lines stack down the page.                                                                                                                                                                      | [Latin script](latin-script.md), [Greek script](greek-script.md), [Cyrillic](cyrillic.md), [Devanagari](../../terms/devanagari.md) |
