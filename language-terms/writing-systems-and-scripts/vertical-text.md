...
Several East Asian scripts can be set vertically, including Chinese, Japanese, and Korean, the traditional Japanese mode being [tategaki](tategaki.md), as well as traditional [Mongolian](../../terms/mongolian-script.md). On the web you set vertical text with the CSS `writing-mode` property: `vertical-rl` stacks lines top to bottom with columns advancing right to left, as in [CJK](../../terms/cjk.md), and `vertical-lr` advances them left to right, as in Mongolian.<sup>1</sup>
...
[CJK](../../terms/cjk.md) · [Font](../../terms/font.md) · [Left-to-right](left-to-right.md) · [Mongolian script (traditional)](../../terms/mongolian-script.md) · [Right-to-left](right-to-left.md) · [Tategaki](tategaki.md) · [Text direction](text-direction.md) · [Writing systems & scripts](./)
