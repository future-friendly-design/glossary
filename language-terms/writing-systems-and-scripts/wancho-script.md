...
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Autonym](../../terms/autonym.md) | Not attested in the sources cited here; the script is referred to as "Wancho" in the Latin alphabet                                                     |
| Languages                         | Wancho                                                                                                                                                  |
...
| [Unicode](../../terms/unicode.md) block                                                       | Wancho, [U+1E2C0 to U+1E2FF](https://www.unicode.org/charts/PDF/U1E2C0.pdf)                                                                                                                                                                                           | The Wancho script is a very recent, purpose-built community script for a small language community, so fonts, a [keyboard layout](../../terms/keyboard-layout.md), and rendering for it are a concrete deliverable; a Latin or [Devanagari](devanagari.md) font will not render it, so confirm [font coverage](../../terms/font-coverage.md) |

### In practice

* **Cover the script, its tone marks, and a way to type it:** confirm the font ships the Wancho letters, tone marks, and digits, positions the tone marks correctly, and is paired with a [keyboard layout](../../terms/keyboard-layout.md). See [font coverage](../../terms/font-coverage.md).
...
* **Check the orthography, and which script the community uses:** Wancho is written in the Wancho script, Devanagari, and Latin, so do not assume one script. Pull per-language conventions from [locale](../../terms/locale.md) data that Unicode's [CLDR](../../terms/cldr.md) publishes.
