...
* **Separate script-level from writing-system-level support:** verify [font coverage](../../terms/font-coverage.md) and shaping at the script level, but localize casing, hyphenation, quotation marks, and number formatting at the writing-system level. The two are different work and different data.
* **Drive writing-system rules from the language, not the script:** the same Latin letters behave differently across languages, so tie orthographic behavior to a [locale](../../terms/locale.md), not to the script alone.

## Related terms

[Language](language.md) · [Script](script.md) · [Orthography](orthography.md) · [Latin script](../../terms/latin-script.md)
