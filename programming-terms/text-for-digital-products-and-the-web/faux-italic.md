...
depth: deep
summary: >-
  Faux italic is a fake slant created by tilting a regular font's glyphs rather
  than using a real italic design.
related:
  - faux-bold
  - typeface
  - variable-font
...
[Faux bold](faux-bold.md) · [Typeface](../../design-terms/typography/typeface.md) · [Variable font](../../design-terms/typography/variable-font.md)
