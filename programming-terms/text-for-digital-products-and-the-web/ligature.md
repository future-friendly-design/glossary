...
When adjacent letters clash or simply read better joined, a font can substitute one combined [glyph](glyph.md); common examples are fi, fl, ff, ffi, and ffl. In [opentype](../../design-terms/typography/opentype.md) this is a [gsub](gsub.md) substitution, with standard ligatures (the "liga" feature) on by default and decorative ones ("dlig") optional. The idea generalizes well beyond Latin: some scripts, like Arabic, rely on required ligatures for correct spelling, and the related [conjunct](../../language-terms/writing-systems-and-scripts/conjunct.md) forms in Indic scripts work on the same substitution principle.
...
[Conjunct](../../language-terms/writing-systems-and-scripts/conjunct.md) · [Glyph](glyph.md) · [GSUB](gsub.md) · [OpenType](../../design-terms/typography/opentype.md) · [OpenType features](../../design-terms/typography/opentype-features.md)
