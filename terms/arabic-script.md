...
| [Ligature](ligature.md) (lam-alef) | the lam-alef combination forms an obligatory ligature where the font's style supports it<sup>7</sup> | Confirm the font ships it; it is expected, not optional |
...
4. The Arabic script is written from right to left - The Unicode Standard, Version 17.0, Chapter 9: Middle East-I [https://www.unicode.org/versions/Unicode17.0.0/core-spec/chapter-9/](https://www.unicode.org/versions/Unicode17.0.0/core-spec/chapter-9/)
