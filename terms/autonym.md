...
## Example
"Deutsch" is the autonym for the language English speakers call by the exonym "German." A script's own name works the same way: देवनागरी is the autonym of the [Devanagari](devanagari.md) script, the name it carries in the languages that use it.

## Related terms
[CLDR](cldr.md) · [Devanagari](devanagari.md) · [Dialect](dialect.md) · [Exonym](exonym.md) · [ISO 639-3](iso-639-3.md) · [Localization](localization.md)

## Further reading
- Foundations: [Endonym and exonym (Wikipedia)](https://en.wikipedia.org/wiki/Endonym_and_exonym)

<!-- NEEDS EXPERT REVIEW: source is Wikipedia (interim). Autonyms are community-specific and the source-of-truth should be CLDR; cohort to confirm framing and that autonym/endonym are treated as synonyms here. -->
