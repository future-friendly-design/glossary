...
For example, বাংলা ("Bangla") is written with letters that join along a top line and hang from it, the way the script runs throughout.
...
| [Hanging baseline](../language-terms/writing-systems-and-scripts/hanging-baseline.md) | letters join along a top line and hang from it |
...
* **Cover the script before you commit a typeface:** confirm the font ships the conjuncts, the matra reordering, and the hanging baseline, AND the two Assamese letters (ৰ, ৱ) if you support Assamese, not just the base Bengali symbols. [Noto Sans Bengali](https://fonts.google.com/noto/specimen/Noto+Sans+Bengali) is a free, open-licensed option, and [Noto](noto-fonts.md) reaches scripts where commercial fonts are scarce. See [font coverage](font-coverage.md).
...
1. The Bangla script is used for writing languages such as Bangla, Assamese, Bishnupriya Manipuri, Garo, Khasi, Mizo, and Santali - The Unicode Standard, Version 16.0, Chapter 12: South Asia-I [https://www.unicode.org/versions/Unicode16.0.0/core-spec/chapter-12/](https://www.unicode.org/versions/Unicode16.0.0/core-spec/chapter-12/)
2. The Bangla script is a North Indian script historically related to Devanagari, and like the other Indic scripts it is an abugida in which each consonant letter carries an inherent vowel - The Unicode Standard, Version 16.0, Chapter 12: South Asia-I [https://www.unicode.org/versions/Unicode16.0.0/core-spec/chapter-12/](https://www.unicode.org/versions/Unicode16.0.0/core-spec/chapter-12/)
...
7. Assamese employs two letters not used for the Bangla language: U+09F0 ৰ for the Assamese "ra" and U+09F1 ৱ for the Assamese "wa" - The Unicode Standard, Version 16.0, Chapter 12: South Asia-I [https://www.unicode.org/versions/Unicode16.0.0/core-spec/chapter-12/](https://www.unicode.org/versions/Unicode16.0.0/core-spec/chapter-12/)
