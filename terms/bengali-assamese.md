...
* **Cover the script before you commit a typeface:** confirm the font ships the Bengali glyphs AND the [shaping rules](../programming-terms/text-for-digital-products-and-the-web/text-shaping.md) that position them, plus the Assamese symbols such as ৰ and ৱ if you support Assamese, not just the base Bengali symbols. See [font coverage](font-coverage.md).
