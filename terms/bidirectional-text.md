...
- **Use logical CSS properties:** `margin-inline`, `text-align: start`, and the like let a layout flip correctly between LTR and RTL instead of being pinned to physical sides. This is part of [[complex-text-layout]]. Confirm RTL behavior with the language experts for those locales.

## Related terms
[[text-direction]] · [[unicode]] · [[complex-text-layout]]
