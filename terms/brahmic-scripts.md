...
aliases: [Indic scripts, Brahmic family]
tags: [writing-systems-scripts]
level: intermediate
depth: core
summary: Brahmic scripts are a large family of South and Southeast Asian writing systems descended from the ancient Brahmi script.
related: [abugida, conjunct, matra, virama, complex-text-layout]
status: voice-passed
version_added: 0.1
updated: 2026-06-18
...
<!-- NEEDS EXPERT REVIEW: source is Wikipedia (interim). Upgrade to an authoritative primary (Unicode Standard chapters on South and Southeast Asian scripts, or a SIL/ScriptSource reference) vetted by the language cohort. -->
