...
* **The text model:** [Character](../programming-terms/text-in-software/character.md), [Glyph](../programming-terms/text-for-digital-products-and-the-web/glyph.md), [Code point](../programming-terms/text-in-software/code-point.md), [Grapheme cluster](../programming-terms/text-in-software/grapheme-cluster.md)
* **The standard and its structure:** [Unicode](../programming-terms/text-in-software/unicode.md), [Plane / Basic Multilingual Plane](../programming-terms/text-in-software/plane-bmp.md)
* **Encodings:** [Character encoding](../programming-terms/text-in-software/character-encoding.md), [UTF-8](../programming-terms/text-in-software/utf-8.md), [UTF-16](../programming-terms/text-in-software/utf-16.md), [Surrogate pair](../programming-terms/text-in-software/surrogate-pair.md)
* **Combining and normalizing:** [Combining mark](../programming-terms/text-in-software/combining-mark.md), [Precomposed character](../programming-terms/text-in-software/precomposed-character.md), [Normalization](../programming-terms/text-in-software/normalization.md), [Diacritic](../language-terms/writing-systems-and-scripts/diacritic.md), [Tone mark](../language-terms/writing-systems-and-scripts/tone-mark.md)
