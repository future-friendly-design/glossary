...
CJK is a collective term for the writing systems of China, Japan, and Korea.<sup>1</sup> The three traditions share a large stock of [Han characters](../language-terms/writing-systems-and-scripts/han-characters.md), which Unicode encodes once as a unified set used across the written Chinese, Japanese, and Korean languages.<sup>2</sup> The grouping is sometimes written CJKV, which is more accurate in a historical sense because earlier Vietnamese writing also used Han characters.<sup>3</sup>
...
| [Han characters](../language-terms/writing-systems-and-scripts/han-characters.md) | All three traditions use Han characters (hanzi, kanji, hanja), encoded once as CJK Unified Ideographs                                                                                    | Set the text's language so the shared [code points](code-point.md) render with the right regional glyphs                                                                |
...
| --------------------------------------------------------------------------------- | ------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Han characters](../language-terms/writing-systems-and-scripts/han-characters.md) | Chinese, Japanese, Korean | 漢字      | [Logographic](../language-terms/writing-systems-and-scripts/logographic.md); tens of thousands of characters; the shared core, with language-dependent glyphs |
| [Hiragana](../language-terms/writing-systems-and-scripts/hiragana.md)             | Japanese                  | ひらがな    | Cursive kana [syllabary](../language-terms/writing-systems-and-scripts/syllabary.md); native words, particles, and inflections                                |
| [Katakana](../language-terms/writing-systems-and-scripts/katakana.md)             | Japanese (also Ainu)      | カタカナ    | Angular kana syllabary; loanwords and emphasis                                                                                                                |
| [Hangul](../language-terms/writing-systems-and-scripts/hangul.md)                 | Korean                    | 한글      | [Featural](../language-terms/writing-systems-and-scripts/featural-alphabet.md); letters (jamo) composed into square syllable blocks                           |
