...
depth: core
summary: >-
  A combining mark is a code point that attaches to the preceding character,
  such as an accent.
related:
...
[Precomposed character](precomposed-character.md) · [Diacritic](../language-terms/writing-systems-and-scripts/diacritic.md) · [Normalization](normalization.md) · [Grapheme cluster](grapheme-cluster.md)
