...
* **Test with real content:** include genuine Arabic, Indic, and other complex-script samples in design and QA, not Latin placeholder text. This connects to [reordering](reordering.md), [stacking-script](stacking-script.md)s, and [bidirectional-text](bidirectional-text.md).
* **Languages:** treat complex-script correctness as expert-verified, not assumed; confirm specifics with the language experts.

## Related terms

[Text shaping](text-shaping.md) · [Reordering](reordering.md) · [Stacking script](stacking-script.md) · [Bidirectional text](bidirectional-text.md) · [Matra](../language-terms/writing-systems-and-scripts/matra.md)
