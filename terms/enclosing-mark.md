...
[Combining mark](combining-mark.md) · [Mark](../language-terms/writing-systems-and-scripts/mark.md) · [Spacing combining mark](spacing-combining-mark.md) · [Grapheme cluster](grapheme-cluster.md)
...
1. An enclosing mark is a nonspacing mark with the General Category Enclosing Mark (Me), a subclass that surrounds the base character - Unicode Glossary: Enclosing Mark [https://www.unicode.org/glossary/#enclosing_mark](https://www.unicode.org/glossary/#enclosing_mark)
