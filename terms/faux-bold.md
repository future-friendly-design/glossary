...
- **Tools:** before you lean on bold in a design, confirm the typeface includes a real bold. A [[variable-font]] with a weight axis is one reliable way to get genuine heavier weights rather than faked ones.

## Related terms
[[faux-italic]] · [[font-weight]] · [[variable-font]]
