...
- **With variable fonts:** a [[variable-font]] cuts file count by packing styles together; subsetting cuts file size by dropping glyphs. The two compose, so you can do both.

## Related terms
[[font-coverage]] · [[fallback-font]] · [[variable-font]] · [[font]]
