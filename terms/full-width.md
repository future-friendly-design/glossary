...
depth: deep
summary: >-
  Full-width characters occupy one full em square, the same width as a typical
  CJK character, unlike narrower half-width forms.
related:
  - tategaki
  - font-coverage
status: voice-passed
...
[Tategaki](../language-terms/writing-systems-and-scripts/tategaki.md) · [Font coverage](font-coverage.md)
