...
| [Font](font.md) (open source) | Noto ships a free, open-source family per region: Noto Sans [SC](https://fonts.google.com/noto/specimen/Noto+Sans+SC) and [TC](https://fonts.google.com/noto/specimen/Noto+Sans+TC) for Chinese, [JP](https://fonts.google.com/noto/specimen/Noto+Sans+JP) for Japanese, and [KR](https://fonts.google.com/noto/specimen/Noto+Sans+KR) for Korean | Pick the regional variant that matches your content's language (see Han unification below), not just any font, or readers see the wrong regional forms; confirm coverage for the languages you support (see [font coverage](font-coverage.md)). [Noto](noto-fonts.md) reaches scripts where commercial fonts are scarce |
...
* **Budget for coverage and size before you commit a typeface:** a Han font carries thousands of glyphs, so plan [subsetting](font-subsetting.md) and loading, and confirm the [font coverage](font-coverage.md) spans the characters your languages need.
