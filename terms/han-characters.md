...
term: Han characters
slug: han-characters
aliases: [hanzi, kanji, hanja, Chinese characters]
tags: [writing-systems-scripts]
level: intermediate
depth: core
summary: Han characters are the logographic Chinese-origin symbols used in Chinese and, in part, in Japanese and Korean writing.
related: [logographic, cjk, hiragana, katakana]
status: voice-passed
version_added: 0.1
updated: 2026-06-18
contributors: [sam-gordashko]
further_reading:
  - title: "Chinese characters (Wikipedia)"
...
<!-- NEEDS EXPERT REVIEW: source is Wikipedia (interim). Upgrade to an authoritative primary (Unicode Standard CJK chapter, Unicode FAQ: Chinese and Japanese) vetted by the cohort. -->
