...
| [Text direction](../language-terms/writing-systems-and-scripts/text-direction.md) | Horizontal left to right, and traditionally vertical: top to bottom in columns running right to left ([tategaki](../language-terms/writing-systems-and-scripts/tategaki.md))<sup>8</sup> | Text runs horizontally by default now, but the traditional vertical form is still used, so support vertical layout if your languages call for it; the layout engine has to substitute the font's vertical forms |
