...
* **Cover the script before you commit a typeface:** confirm the font renders the syllable blocks cleanly (and composes conjoining jamo, if your data uses them), not just isolated letters. See [font coverage](font-coverage.md).
