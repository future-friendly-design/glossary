...
* **Cover all three scripts, not just the kana:** confirm the font sets hiragana, [katakana](katakana.md), and [kanji](han-characters.md) together with compatible weights and metrics, and renders the voiced-sound marks, not just the base symbols. See [font coverage](font-coverage.md).
