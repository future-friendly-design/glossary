...
| [Text direction](../language-terms/writing-systems-and-scripts/text-direction.md) | Horizontal [left to right](../language-terms/writing-systems-and-scripts/left-to-right.md), and traditionally [vertical](vertical-text.md): top to bottom in columns running right to left ([tategaki](../language-terms/writing-systems-and-scripts/tategaki.md))<sup>6</sup> | Support vertical layout if your text calls for it; vertical setting substitutes the font's [OpenType](opentype.md) vertical forms, and the layout engine, not styling, places them |
