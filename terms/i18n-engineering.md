...
entry_type: overview
summary: >-
  Internationalization and engineering covers the practices, data, and tooling
  that let one product work correctly across languages and regions, from the
  up-front design work to locale data, sorting, segmentation, and input.
related:
  - characters-encoding
  - shaping-layout
status: voice-passed
...
* **Locale-aware text behavior:** [Collation](../programming-terms/text-for-digital-products-and-the-web/collation.md), [Segmentation](../programming-terms/text-in-software/segmentation.md)
