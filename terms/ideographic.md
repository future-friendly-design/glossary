...
further_reading:
  - title: "Ideogram (Wikipedia)"
    url: https://en.wikipedia.org/wiki/Ideogram
    type: authority
license: CC-BY-4.0
---
...
## Further reading
- Foundations: [Ideogram (Wikipedia)](https://en.wikipedia.org/wiki/Ideogram)

<!-- NEEDS EXPERT REVIEW: source is Wikipedia (interim). Upgrade to an authoritative primary (Unicode glossary, a writing-systems reference) vetted by the SILCON cohort. The characterization of Chinese characters as logographic rather than ideographic is well established in linguistics but should be confirmed by the cohort. -->
