...
## In practice
- **The i18n checklist:** externalize all user-facing strings, use Unicode (UTF-8) end to end, format dates/numbers/currency through a [[locale]]-aware library rather than by hand, and design layouts that tolerate [[text-expansion]] and [[bidirectional-text]].
...
- **Verify early:** test with [[pseudolocalization]] before real translations exist, so missing i18n shows up while it is cheap to fix. See [Localization vs. Internationalization (W3C)](https://www.w3.org/International/questions/qa-i18n).

## Related terms
[[localization]] · [[locale]] · [[text-expansion]] · [[pseudolocalization]]
