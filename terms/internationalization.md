...
depth: deep
summary: >-
  Internationalization is designing and building software so it can be adapted
  to different languages and regions without re-engineering it later.
related:
  - localization
  - locale
  - text-expansion
...
* **The i18n checklist:** externalize all user-facing strings, use Unicode (UTF-8) end to end, format dates/numbers/currency through a [locale](locale.md)-aware library rather than by hand, and design layouts that tolerate [text-expansion](text-expansion.md) and [bidirectional-text](../language-terms/writing-systems-and-scripts/bidirectional-text.md).
