...
term: Joining
slug: joining
aliases: [cursive joining, joining forms, contextual forms]
tags: [shaping-layout]
level: intermediate
depth: deep
summary: >
...
## Definition
Joining is the behavior in some scripts where signs connect and change shape based on their position in a word.
