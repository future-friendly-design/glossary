...
<!-- NEEDS EXPERT REVIEW: Glottolog used as the language-database authority hub (general hub OK for an overview). The speakers-and-vitality terms in this cluster are data-sensitive: this overview asserts no figures or statuses, and the cohort is the verification layer for all of them. -->
