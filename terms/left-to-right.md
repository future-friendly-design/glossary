...
level: foundational
depth: core
summary: Left-to-right (LTR) is a text direction where a script is written and read from the left edge of the line to the right.
related: [text-direction, right-to-left, bidirectional-text]
status: voice-passed
version_added: 0.1
updated: 2026-06-26
...
Left-to-right (LTR) is a text direction where a script is written and read from the left edge of the line to the right.
...
[Bidirectional text](bidirectional-text.md) · [Latin script](latin-script.md) · [Right-to-left](right-to-left.md) · [Text direction](text-direction.md) · [Writing systems & scripts](../language-terms/writing-systems-and-scripts/)
