...
term: Normalization
slug: normalization
aliases: [Unicode normalization, NFC, NFD]
tags: [characters-encoding]
level: advanced
depth: deep
summary: Normalization rewrites text into a consistent form so that strings that look the same compare as equal.
related: [precomposed-character, combining-mark, grapheme-cluster, unicode]
status: voice-passed
version_added: 0.1
updated: 2026-06-18
