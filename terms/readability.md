...
related: [legibility, leading, line-height, measure, tracking]
status: voice-passed
version_added: 0.1
updated: 2026-06-25
...
* **Set measure with a token, not by eye:** cap line length in the comfortable range so paragraphs do not stretch across wide screens, where the eye loses the start of the next line. See [measure](measure.md).
* **Tune leading to the text, not a default:** body copy, dense tables, and large headings each want different [line height](line-height.md); set them as steps in the type scale so the rhythm stays consistent across components.
...
[Leading](leading.md) · [Legibility](legibility.md) · [Line height](line-height.md) · [Measure](measure.md) · [Tracking](tracking.md)
