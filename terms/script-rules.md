...
term: Script rules
slug: script-rules
aliases: [script behaviors, script-specific behavior]
...
## Related terms
[Script](script.md) · [Complex text layout](complex-text-layout.md) · [Text direction](text-direction.md) · [Joining](joining.md) · [Reordering](reordering.md) · [Stacking script](stacking-script.md)
