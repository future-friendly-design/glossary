...
| [Text direction](../language-terms/writing-systems-and-scripts/text-direction.md) | Left to right<sup>7</sup> | Left-aligned text as the default |
...
7. Syloti Nagri text runs left to right in horizontal lines - Syloti Nagri (r12a script notes) [https://r12a.github.io/scripts/sylo/syl.html](https://r12a.github.io/scripts/sylo/syl.html)
...
9. U+A806 SYLOTI NAGRI SIGN HASANTA indicates a word-final consonant, or is inserted between consonants to represent a conjunct - The Unicode Standard, Version 17.0, Chapter 15: South and Central Asia-IV [https://www.unicode.org/versions/Unicode17.0.0/core-spec/chapter-15/](https://www.unicode.org/versions/Unicode17.0.0/core-spec/chapter-15/)
</content>
