...
<!-- NEEDS EXPERT REVIEW: source is Wikipedia (interim). Upgrade to an authoritative primary (Unicode Standard Section 12.6 Tamil, ScriptSource: Taml) vetted by the SILCON cohort. The script-to-language mapping (Tamil as a Dravidian language of South India and Sri Lanka) and any reordering specifics need cohort confirmation; no letter counts are asserted. -->
