...
| [Conjuncts](../language-terms/writing-systems-and-scripts/conjunct.md) | Tamil forms only one consonant conjunct, writing consonant clusters with a visible pulli instead<sup>7</sup> | A cluster that Devanagari would fuse stays as separate symbols marked with the pulli, so do not expect heavy conjunct behaviour |
...
4. Tamil, in common with the other scripts of the Indic family, is written from left to right - The Unicode Standard, Version 17.0, Chapter 12: South Asia-I [https://www.unicode.org/versions/Unicode17.0.0/core-spec/chapter-12/](https://www.unicode.org/versions/Unicode17.0.0/core-spec/chapter-12/)
