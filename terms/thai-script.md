...
level: intermediate
depth: core
summary: Thai script is the Brahmic abugida used to write the Thai language, with marks for tones.
related: [abugida, brahmic-scripts, tibetan-script, tone-mark]
status: voice-passed
version_added: 0.1
updated: 2026-06-18
...
<!-- NEEDS EXPERT REVIEW: source is Wikipedia (interim). Upgrade to an authoritative primary (Unicode Standard Southeast Asian scripts chapter, ScriptSource: Thai) vetted by the cohort. Counts (44 consonants, 4 tone marks) and the no-spaces segmentation point to confirm. -->
