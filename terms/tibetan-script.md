...
For example, བོད་ཡིག ("böyig", "Tibetan writing") puts a dot called a tsheg between its two syllables, བོད and ཡིག, because Tibetan separates syllables rather than spacing words.
...
| [Tsheg](../language-terms/writing-systems-and-scripts/tsheg.md) | a dot separates syllables, and Tibetan does not put spaces between words, so line breaking keys on the tsheg |
...
2. The Tibetan script has thirty consonants, each represented by a discrete character carrying an inherent vowel, with vowel marks applied to indicate other vowels - The Unicode Standard, Version 16.0, Chapter 13: South and Central Asia-II [https://www.unicode.org/versions/Unicode16.0.0/core-spec/chapter-13/](https://www.unicode.org/versions/Unicode16.0.0/core-spec/chapter-13/)
3. The Tibetan script is written from left to right - The Unicode Standard, Version 16.0, Chapter 13: South and Central Asia-II [https://www.unicode.org/versions/Unicode16.0.0/core-spec/chapter-13/](https://www.unicode.org/versions/Unicode16.0.0/core-spec/chapter-13/)
...
5. Tibetan does not put spaces between words; the primary line-break character is the interword tsheg (U+0F0B), which separates syllables - The Unicode Standard, Version 16.0, Chapter 13: South and Central Asia-II [https://www.unicode.org/versions/Unicode16.0.0/core-spec/chapter-13/](https://www.unicode.org/versions/Unicode16.0.0/core-spec/chapter-13/)
