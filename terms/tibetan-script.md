...
depth: core
summary: >-
  Tibetan script is the Brahmic abugida used for Tibetan and related languages
  such as Dzongkha and Ladakhi.
related:
  - abugida
  - brahmic-scripts
  - thai-script
...
contributors:
  - sam-gordashko
further_reading:
  - title: Tibetan script (Wikipedia)
...
[Abugida](abugida.md) · [Brahmic scripts](brahmic-scripts.md) · [Thai script](thai-script.md) · [Tsheg](../language-terms/writing-systems-and-scripts/tsheg.md) · [Stacking script](../language-terms/writing-systems-and-scripts/stacking-script.md)
