...
level: intermediate
depth: core
summary: Tibetan script is the Brahmic abugida used for Tibetan and related languages such as Dzongkha and Ladakhi.
related: [abugida, brahmic-scripts, thai-script, tsheg, stacking-script]
status: voice-passed
version_added: 0.1
updated: 2026-06-18
...
<!-- NEEDS EXPERT REVIEW: source is Wikipedia (interim). Upgrade to an authoritative primary (Unicode Standard Tibetan chapter, W3C tlreq, ScriptSource: Tibt) vetted by the cohort. Consonant count (30), vowel-sign count (4), and stacking/tsheg specifics to confirm. -->
