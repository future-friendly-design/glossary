...
level: foundational
depth: deep
summary: Tracking is uniform spacing applied evenly across a run of letters, words, or a whole block of text.
related: [kerning, leading, letter-spacing]
status: voice-passed
version_added: 0.1
updated: 2026-06-18
...
## Why it matters
If kerning is tweezers for one letter pair, tracking is the volume knob for the whole line: turn it up to open text out, down to pull it tighter. It earns its keep in two spots especially, all-caps text and small labels, which both tend to feel cramped and read better with a little extra space.
