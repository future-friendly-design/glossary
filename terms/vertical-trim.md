...
depth: deep
summary: >-
  Vertical trim removes the extra space a font reserves above and below its
  letters so text aligns to cap height and baseline.
tool_names:
  figma: Vertical trim
  css: text-box-trim
related:
...
[Cap height](cap-height.md) · [Baseline](../design-terms/typography/baseline.md) · [Line height](line-height.md) · [Leading](leading.md)
