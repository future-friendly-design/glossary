...
| [Complex text layout](complex-text-layout.md) | Not required: a linear alphabet, rendered directly (no conjuncts or reordering) | So there is no reordering or contextual analysis; see the OpenType and Text shaping rows below |
| [Font](font.md) (open source) | [Noto Sans Warang Citi](https://fonts.google.com/noto/specimen/Noto+Sans+Warang+Citi) is a free, open-source font covering the script's characters and any shaping it needs | Start here rather than licensing or commissioning a commercial typeface; confirm it covers the languages you support (see [font coverage](font-coverage.md)). [Noto](noto-fonts.md) reaches scripts where commercial fonts are scarce |
...
* **Cover the script and give people a way to type it:** confirm the font ships the Warang Citi capital and small letters and digits, and pair it with a [keyboard layout](keyboard-layout.md) so the community can enter text. See [font coverage](font-coverage.md).
