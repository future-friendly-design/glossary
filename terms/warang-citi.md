...
term: Warang Citi
slug: warang-citi
aliases: [Varang Kshiti, Warang Kshiti]
tags: [writing-systems-scripts]
level: advanced
depth: core
summary: Warang Citi is the alphabet devised by Lako Bodra for the Ho language of eastern India.
related: [alphabet, ol-chiki, wancho-script, script]
status: voice-passed
version_added: 0.1
updated: 2026-06-18
contributors: [sam-gordashko]
further_reading:
  - title: "Warang Citi (Wikipedia)"
    url: https://en.wikipedia.org/wiki/Warang_Citi
    type: authority
license: CC-BY-4.0
---
...
<!-- NEEDS EXPERT REVIEW: source is Wikipedia (interim). Recommended primary upgrade: ScriptSource (scr code Wara, https://scriptsource.org/scr/Wara) and the Unicode chart; confirm the ScriptSource URL resolves (bot-blocks fetchers). Unicode 7.0 (2014) / block U+118A0-U+118FF verified via Wikipedia, confirm against Unicode primary. Cohort to verify: Ho speaker numbers and script vitality (NOT stated here), creator attribution, and the proportion using Warang Citi vs Devanagari. -->
